...
**Ամենակարճ ձևը՝** `scripts/deploy.sh`։ Այն **նախ** վազեցնում է lint, typecheck և
թեստերը, և ձախողման դեպքում **ոչինչ չի ուղարկում** (`--skip-checks`՝ շրջանցելու
համար, բայց դա վատ գաղափար է)։ Հետո շինում է, ուղարկում, վերագործարկում և
ստուգում՝ ներառյալ WebSocket-ի upgrade-ը։

Այս դարպասը գոյություն ունի կոնկրետ պատճառով. lint-ի սխալը **երեք անգամ** հասավ
արտադրություն, որովհետև ձեռքով վազեցնելիս կարդում էի ելքի վերջին տողերը, որտեղ
eslint-ի պաստառն է, ոչ թե սխալը։ Ելքի կոդը կարդացող դարպասը այդ սխալը չի անում։
...
`Restart=always`-ը ծածկում է այն դեպքը, երբ պրոցեսը **դուրս է գալիս**։ Այն չի
ծածկում այն, երբ պրոցեսը կենդանի է, բայց այլևս չի պատասխանում — կախված event
loop-ը systemd-ի աչքին կատարյալ առողջ է։

`wallrush-watchdog.timer`-ը ամեն 2 րոպեն մեկ հարցնում է այն, ինչ systemd-ը չի
կարող. **պատասխանո՞ւմ է**։ Երկու անընդմեջ ձախողումից հետո վերագործարկում է
ծառայությունը և գրում journald-ում (`journalctl -t wallrush-watchdog`)։ Երկու
հարված են պետք, որպեսզի մեկ դանդաղ պահը վերագործարկման պատճառ չդառնա։

Ստուգված է իրական վերագործարկումով, ոչ թե ենթադրությամբ (նույն սկրիպտը՝ մեռած
պորտին ուղղված). առաջին հարվածից հետո **չի** վերագործարկում, երկրորդից հետո՝
վերագործարկում է, առողջ վազքը վիճակի ֆայլ չի թողնում։
